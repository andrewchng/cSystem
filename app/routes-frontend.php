...
Route::get($route_padding . 'operator/home', array('before' => '', 'uses' => 'FrontendController@dashboard_masterView'));
...
Route::get($route_padding .'report/edit/{id}', array('before' => '', 'uses' => 'FrontendController@dashboard_masterView'));
Route::get($route_padding . 'agency', array('before' => '', 'uses' => 'FrontendController@dashboard_masterView'));
Route::get($route_padding . 'agency/manage_report', array('before' => '', 'uses' => 'FrontendController@dashboard_masterView'));
Route::get($route_padding . 'report/update/{id}', array('before' => '', 'uses' => 'FrontendController@dashboard_masterView'));
