        ...
        return {
            ...
            controller: function ($scope, $attrs, $element, Activities) {
                ...
                Activities().success(function(data) {
                    ...
                    for(var j=0; i<data.agencies_updated.length; j++)
                        $scope.messages.push('<i class="circle-yellow fa fa-circle"></i>' + 'Existing Agency <b>' + data.agencies_updated[i].agencyName + '</b> updated. <b>Address:</b> ' + data.agencies_updated[j].agencyAddress + ' <b>Telephone:</b> ' + data.agencies_updated[j].agencyTel);
                    ...
                    for(var j=0; i<data.reports_updated.length; j++)
                        $scope.messages.push('<i class="circle-yellow fa fa-circle"></i>' + 'Existing Report <b>' + data.reports_updated[i].reportName + '</b> updated. <b>Current Status:</b> ' + data.reports_updated[j].reportStatusTypeName + ' <b>Incident Location:</b> ' + data.reports_updated[j].location);
